...
def jalankan_tool():
	os.system("rohman.py" if os.name == "nt" else "python2 rohman.py")
clear_dev()
...
\_|  |_|____/\_|     \_|  |/   \___|_| |_| |/"""
	print a+"+-----------------------+"
	print a+"|"+j+" >_ "+h+"Author"+p+":"+k+" Rohman "+a+" /"+p+ "| IP Sekarang: "
...
if __name__ == "__main__":
	...
	def opsi_log():
		try:
			...
			print h+" ["+p+"3"+h+"]"+k+" Ikuti Facebook"+p+" zidanxganzz"
			...
			if pilih == "1":
				...
				try:
					subprocess.check_output(['am', 'start', 'https://www.facebook.com/Zidan.Ganzz.56'])
					jalankan_tool()
				except:
					jalankan_tool()
			elif pilih == "4":
